package ch.linst.hoatutahi.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    public static final int DESKTOP_SCREEN_SIZE_CORRECTION = 3;
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        configuration.setWindowedMode(
            HoatuTahi.VIRT_SCREEN_WIDTH / DESKTOP_SCREEN_SIZE_CORRECTION,
            HoatuTahi.VIRT_SCREEN_HEIGHT / DESKTOP_SCREEN_SIZE_CORRECTION);
